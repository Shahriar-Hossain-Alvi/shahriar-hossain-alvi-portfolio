...
const Banner = () => {
    return (
        <div id="banner" className="relative hero  mb-[700px]" style={{ backgroundImage: `url(${bannerBG})` }}>
            <div className="hero-content text-center pt-20 pb-12">
                <div className="pb-8">
                ...
                <img className="lg:w-36 lg:h-36 w-32 h-32 border-4 rounded-full absolute left-1/2 -translate-x-1/2 -bottom-1/4 lg:-bottom-1/4 border-[#B4B4B4]" src={userImage} alt="" />
            </div>
